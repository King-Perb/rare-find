...
export const mockListingOverpricedReplica: MarketplaceListing = {
  ...
  currency: 'USD',
  images: [
    'https://m.media-amazon.com/images/I/61H28lAgJBL._AC_SL1500_.jpg',
    'https://m.media-amazon.com/images/I/71K5X8Y9ZJL._AC_SL1500_.jpg',
  ],
  category: 'Antiques',
  condition: 'vintage',
...
export const mockListingGoodDeal: MarketplaceListing = {
  ...
  currency: 'USD',
  images: [
    'https://m.media-amazon.com/images/I/81ABC123._AC_SL1500_.jpg',
  ],
  category: 'Antiques',
  condition: 'vintage',
...
export const mockListingSlightlyOverpriced: MarketplaceListing = {
  ...
  currency: 'USD',
  images: [
    'https://m.media-amazon.com/images/I/82GHI789._AC_SL1500_.jpg',
  ],
  category: 'Antiques',
  condition: 'vintage',
