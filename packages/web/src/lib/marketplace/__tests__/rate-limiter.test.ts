...
let getRateLimiter: typeof import('../rate-limiter').getRateLimiter;
let waitForRateLimit: typeof import('../rate-limiter').waitForRateLimit;
...
describe('MarketplaceRateLimiter', () => {
  beforeEach(async () => {
    ...
    vi.resetModules();
    const limiterModule = await import('../rate-limiter');
