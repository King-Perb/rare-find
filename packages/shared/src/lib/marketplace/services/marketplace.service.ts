 ...
 * Platform-agnostic implementation that accepts marketplace clients via dependency injection
 */

import type { IMarketplaceService, ILogger } from '../../interfaces';
import type { MarketplaceListing, MarketplaceSearchParams, MarketplaceSearchResult, MarketplaceClient } from '../types';
...
export class MarketplaceService implements IMarketplaceService {
  constructor(
    ...
    private readonly ebayClient: MarketplaceClient
  ) {
  ...
  parseMarketplaceUrl(url: string): {
    ...
    try {
      ...
      if (urlObj.hostname.includes('amazon.')) {
        ...
        // Note: Match against full URL string, not just pathname
